...
A copy can be gotton from {GitHub}[http://github.com/arkhitech/redmine_timesheet_plugin]

== Installation and Setup

1. In your redmine root directory, run the command: `git clone https://github.com/arkhitech/redmine_timesheet_plugin.git plugins/redmine_timesheet_plugin`
